        ...
        <>
          ...
          >
            ...
            <div className="mt-auto shrink-0 pt-5">
              <div className="rounded-3xl border border-[#ece9f1] bg-[#faf9fc] p-4">
          ...
          {menuOpen && <button type="button" className="fixed inset-0 z-[290] bg-[#1e1729]/25 backdrop-blur-sm lg:hidden" onClick={closeMenu} aria-label={t("Close menu overlay")} />}
        </>,
        portalHost,
      )}
    </>
