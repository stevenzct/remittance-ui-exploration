    ...
    <div className="wireframes-page space-y-4 sm:space-y-8 lg:space-y-10">
      <section className="wireframes-hero ui-surface relative isolate overflow-hidden rounded-[26px] sm:rounded-[36px]">
        <div className="relative px-5 py-11 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-[#f1edfb] px-3 py-2 text-[11px] font-bold uppercase tracking-[0.14em] text-[#381c8d]">
              <DashboardIcon icon={DASHBOARD_ICONS.wireframesNavigation} width="16" />
              Created by Product Manager Ms. Yolanda
            </span>
            <h2 className="mt-6 text-[2.45rem] font-bold leading-[.95] tracking-[-0.06em] text-[#1d1822] sm:mt-7 sm:text-6xl lg:text-7xl">
              <span className="block">Interface Foundations</span>
            </h2>
            <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-[#77717f] sm:mt-7 sm:text-lg">
              Early homepage and work-country flow before visual styling.
            </p>
            <div className="mx-auto mt-8 grid max-w-md grid-cols-1 gap-3 min-[390px]:grid-cols-2 sm:mt-10 sm:flex sm:max-w-none sm:flex-wrap sm:justify-center">
              <Link
                href="/prototype"
        ...
        <div id="wireframe-flow" className="relative scroll-mt-24 p-5 sm:p-9 lg:p-12" aria-labelledby="wireframe-flow-title">
          <h3 id="wireframe-flow-title" className="sr-only">Wireframe flow</h3>
          <LightGallery
            ...
            {WIREFRAMES.map((wireframe) => (
              <article key={wireframe.step} className="group min-w-0">
                <div className="mb-4 flex items-center gap-3 px-1">
                  ...
                  <h4 className="text-lg font-bold tracking-[-.03em] text-[#2b2730]">{wireframe.title}</h4>
                </div>
                ...
                <a
                  ...
                  aria-label={`View larger: ${wireframe.title}`}
                >
      ...
      <section className="revision-cta relative overflow-hidden rounded-[26px] bg-[#25105f] p-6 text-white shadow-[0_24px_64px_rgba(37,16,95,.24)] sm:rounded-[36px] sm:p-10 lg:p-12">
        ...
        <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
          <div className="max-w-2xl">
            <p className="text-[11px] font-bold uppercase tracking-[.16em] text-[#cabcf1]">Ready to explore</p>
            <h2 className="mt-3 text-3xl font-bold tracking-[-.05em] sm:text-5xl">See how these wireframes became the final design.</h2>
            <p className="mt-4 max-w-xl text-sm leading-6 text-white/68 sm:text-base sm:leading-7">
              Open the interactive homepage to see how these early flows evolved into the current design.
            </p>
          </div>
          <Link
            href="/prototype"
